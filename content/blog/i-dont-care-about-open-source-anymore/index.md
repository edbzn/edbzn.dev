...
J'y a ai investi une partie de mon temps libre, mais au fur et à mesure, j'ai commencé à ressentir un désintérêt croissant, jusqu'à totalement abandonner.

## Pourquoi j'ai commencé l'open source

L'open source m'a attiré pour plusieurs raisons :

- **Apprentissage** : contribuer à des projets open source m'a permis d'approfondir mes compétences, et d'aborder les meilleures pratiques de développement.
- **Impact** : j'aimais l'idée que mon travail puisse être utilisé par d'autres personnes, et impacter indirectement un grand nombre d'utilisateurs.
- **Reconnaissance** : contribuer à des projets populaires m'a donné une certaine visibilité et reconnaissance dans la communauté.

Je voyais l'open source comme un moyen d'apprendre, de construire ma réputation, et de contribuer aux technologies que j'utilisais au quotidien en entreprise. Cela a été essentiel lorsque j'ai décidé de me lancer en freelance. Particulièrement du fait que j'avais choisi de quitter la ville et d'habiter à la montagne, loin des opportunités traditionnelles.

## Le pic de mon intérêt

J'ai investi de plus en plus de temps dans l'open source, jusqu'à faire partie de l'équipe de mainteneurs de projets relativement populaires, comme [RxAngular](https://github.com/rx-angular/rx-angular), et à créer mes propres outils, comme [SemVer](https://github.com/jscutlery/semver).
...
C'est à ce moment que le début de l'IA générative a commencé à transformer le paysage du développement logiciel.
